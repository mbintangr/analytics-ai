  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative group">
        ...
        <input
          className={`w-full border text-base rounded-lg block p-3.5 placeholder-slate-600 focus:outline-none focus:ring-0 transition-all duration-300 focus:shadow-[0_0_15px_rgba(13,89,242,0.4)] focus:border-primary ${icon ? "pl-10" : ""} ${className}`}
          style={{
